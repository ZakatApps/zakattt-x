        ...
        if system.connection():
          ...
          if system.sudo != None:
            if os.path.exists(system.home+"/Tool-X"):
              ...
              os.system(system.sudo+" git clone https://github.com/ZakatApps/zakattt-x.git "+system.home+"/Zakat-X")
            if os.path.exists(system.home+"/Zakat-X/install.aex"):
              os.system("cd "+system.home+"/Zakat-X && "+system.sudo+" sh install.aex")
            ...
            if os.path.exists(system.home+"/Zakat-X"):
              pass
            else:
              os.system("git clone https://github.com/ZakatApps/zakattt-x.git "+system.home+"/Zakat-X")
            if os.path.exists(system.home+"/Zakat-X/install.aex"):
              os.system("cd "+system.home+"/Zakat-X && sh install.aex")
              if os.path.exists(system.bin+"/Tool-X") and os.path.exists(system.conf_dir+"/Zakat-X"):
                os.system("clear")
                logo.updated()
                cmd=input("\033[1;36m ##> \033[00m")
              else:
  ...
  def menu(self):
    while True:
      ...
      if cmd == "1":
        ...
        logo.exit()
        break
      elif cmd=="rm -t" or cmd=="rm -T" or cmd=="uninstall tool-x" or cmd=="unistall Zakat-X":
        system=sys()
        if system.sudo:
          os.system(system.sudo+" rm -rf "+system.bin+"/Zakat-X")
          os.system(system.sudo+" rm -rf "+system.bin+"/zakatx")
          os.system(system.sudo+" rm -rf "+system.conf_dir+"/Zakat-X")
        else:
          os.system("rm -rf "+system.bin+"/Zakat-X")
          os.system("rm -rf "+system.bin+"/zakatx")
          os.system("rm -rf "+system.conf_dir+"/Zakat-X")
        os.system("clear")
        logo.exit()
        break
      else:
...
class tools:
  ...
  def __init__(self):
    system=sys()
    with open(system.conf_dir+"/Zakat-X/core/data.json") as data_file:
      self.data=json.load(data_file)
    with open(system.conf_dir+"/Zakat-X/core/cat.json") as cat_file:
