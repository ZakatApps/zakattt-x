...
*Zakat-X is a Kali Linux hacking tools installer for Termux and linux system.*
Zakat-X was developed for Termux and linux based systems. Using Tool-X, you can install almost 370+ hacking tools in Termux (android) and other Linux based distributions. Now Tool-X is available for Ubuntu, Debian etc.
...
- (3) : If you want to update Zakat-X.
- (4) : If you want to know About Us.
- (x) : To exit the tool.

<br/>

Type `Zakat-X` or `zakatx` from anywhere in your terminal to open Zakat-X.
